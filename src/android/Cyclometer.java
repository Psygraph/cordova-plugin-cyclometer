 ...
 */
public class Cyclometer extends CordovaPlugin implements SensorEventListener {
    ...
    */
    private int start() {
        ...
        this.setStatus(Cyclometer.STARTING);
        ...
        if ((list != null) && (list.size() > 0)) {
          ...
          if (this.sensorManager.registerListener(this, this.mSensor, SensorManager.SENSOR_DELAY_UI)) {
              ...
              this.setStatus(Cyclometer.ERROR_FAILED_TO_START);
              this.fail(Cyclometer.ERROR_FAILED_TO_START, "Device sensor returned an error.");
              return this.status;
          };

        } else {
          this.setStatus(Cyclometer.ERROR_FAILED_TO_START);
          this.fail(Cyclometer.ERROR_FAILED_TO_START, "No sensors found to register accelerometer listening to.");
          return this.status;
        }
    ...
    private void stop() {
        stopTimeout();
        if (this.status != Cyclometer.STOPPED) {
    ...
    private void timeout() {
        if (this.status == Cyclometer.STARTING &&
            this.accuracy >= SensorManager.SENSOR_STATUS_ACCURACY_MEDIUM) {
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        this.setStatus(Cyclometer.RUNNING);
